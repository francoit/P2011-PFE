...
<?php //adminestquotecblworktypeaddl.php - copyright 2001 by Noguska - Fostoria, OH
     echo texttitle('Work Type Question');
     if ($delete&&$id) { //if update
       if ($conn->Execute('update estquotecblworktypeaddl set cancel=1, canceluserid='.sqlprep($userid).', canceldate=NOW() where id='.sqlprep($id)) === false) {
     ...
     if ($save) {
       ...
       echo '<form action="adminestquotecblworktypeaddl.php" method="post" name="mainform"><table border="1">';
       ...
       echo '<a href="javascript:confirmdelete(\'adminestquotecblworktypeaddl.php?delete=1&id='.$id.'\');">Delete this Question</a>';
?>
