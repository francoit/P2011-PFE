...
//sybase = sybase (experimental)
  ...
  //Addded /winnt/temp for win2k thanks to mack lescano 8/17/2003
 ...
 } elseif(file_exists('/winnt/temp')) {
     $ADODB_CACHE_DIR='/winnt/temp';
 };
...
//define = 0 will display the original left/right frame menu ; define = 1 will display the new horizontal top menu
  define('CSS_MENU','1');

//path to ttf fonts for dynamically generated images.
  define('FONT_PATH', dirname(__FILE__).'/../utilities/fonts/');
  define('TTF_DIR', dirname(__FILE__).'/../utilities/fonts/');
...
/*language to use by default
  ...
  SD_CNGB2312
*/ 
// This the the default languages Before the User login.
// It will change to the user prefered languages after login success.
  define('DEFAULT_LANG', SD_ENGLISH);
  define('DEFAULT_STR_CHAR_SET', 'utf-8');
  
//This is the System Define languages. 
//This will overwrite Any user define languages. 
//Shouldn't be enable if you want to use user customizable languages
...
//Site Name is displayed various places throughout the site.  It should be your company name, or something associated with it
  define('SITE_NAME', 'ARIA');

//NOLA Software version
  define('SOFTWARE_VERSION', '0.99-5');
