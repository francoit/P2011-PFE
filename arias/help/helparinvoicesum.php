...
?>
<?php
//helparinvoicesum.php

echo '<center><b>Invoice Summary - Part One</b></center><br>';
echo '';
echo '<b>BEGIN PERIOD: </b>Beginning INVOICE Date for report. Enter Date or click on calendar icon for easy date entry.<br><br>';
echo '<b>END PERIOD: </b>Ending INVOICE Date for report. Enter Date or click on calendar icon for easy date entry.<br><br>';
echo '<b>SHOW INVOICES: </b>Select whether to show ALL or only OPEN invoices.<br><br>';
echo '<b>REPORT: </b>Select the level of detail to appear on the report.<br><br>';
echo '<b>ORDER BY: </b>Select the sort order for the report.<br><br>';
...
echo '<center><b>Add New Order - Part Five</b></center><br>';
