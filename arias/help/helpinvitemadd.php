...
<?php
//helpinvitemadd.php
     echo '<center><b>Inventory Item Add</b></center><br>';
     ...
     echo '<b>GL ACCOUNT: </b> Inventory type General Ledger account to use when posting usages/receipts.<br><br>';
     ...
     echo '<b>URL/FILE FOR PRODUCT SHEET: </b>If you want to create a file containing a product sheet (either locally or somewhere on the web at a manufacturers site) this can point to that place to pull up the information to be printed.<br><br>';
     echo '<b>URL/FILE FOR PRODUCT GRAPHIC: </b>Pointer to where a picture of the product can be found -- to be used in a catalog<br><br>';
?>
