...
?>
<?php
     echo '<center><b>Customer Add</b></center><br>';
     echo 'This page allows entry of Customers for use in Receivables, Estimating, and Inventory Sales.<br><br>';
     ...
     echo '<b>NOTE: To add shipping information after adding a customer, use UPDATE customer.</b><br><br>';
